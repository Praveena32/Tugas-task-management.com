...
export const GoogleIcon: React.FC<{ size?: number; color?: string }> = ({ size = 20, color = '#FFFFFF' }) => (
  <Box
    component="svg"
...
export const AppleIcon: React.FC<{ size?: number; color?: string }> = ({ size = 20, color = '#FFFFFF' }) => (
  <Box
    component="svg"
    sx={{ width: size, height: size, display: 'block', fill: color }}
    viewBox="0 0 24 24"
  >
...
export const FacebookIcon: React.FC<{ size?: number; color?: string }> = ({ size = 20, color = '#FFFFFF' }) => (
  <Box
    component="svg"
    sx={{ width: size, height: size, display: 'block', fill: color }}
    viewBox="0 0 24 24"
