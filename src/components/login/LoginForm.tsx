...
export const LoginForm: React.FC = () => {
  ...
  const handleLoginSubmit = (e: React.FormEvent) => {
    ...
    if (isUserValid && isPassValid) {
      setToastMessage('Form validated. Continue with Google to sign in.');
    }
  };
    ...
    >
      ...
      >
        ...
        <Tooltip title="Sign in with Apple" arrow>
          <IconButton
            onClick={() => setToastMessage('Apple login')}
        ...
        <Tooltip title="Sign in with Facebook" arrow>
          <IconButton
            onClick={() => setToastMessage('Facebook login')}
      ...
      <Box sx={{ textAlign: 'center' }}>
        ...
        >
          ...
          <Box
            component="span"
            onClick={() => setToastMessage('Registration coming soon')}
            sx={{
              color: '#9FD094',
              fontWeight: 200,
              cursor: 'pointer',
